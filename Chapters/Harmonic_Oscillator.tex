...
\begin{figure}
    ...
    \caption{An oscillationg spring pendulum at different moments in time. Below each snapshot, the force $F$ experienced by the mass and its speed $v$ are shown. }
