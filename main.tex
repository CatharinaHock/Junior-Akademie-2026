...
If we now interpret the angle as a variable $x$ (in radians) and plot $\sin(x)$, we obtain the sine function, which describes periodic motion (see Fig. \ref{img:sinusfunktion}).
